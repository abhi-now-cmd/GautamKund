...
document.getElementById("gen").addEventListener("click",()=>{
    const cur_sno ="पत्रांक: " + "0" + ""+ document.getElementById("sno").value +  "/" + "" + date.getFullYear() ;
    document.querySelector(
        "div .notice"
    ).innerHTML = "<p>" + document.getElementById("notice").value+ "</p>";
    document.querySelector(
        "div .notice"
    ).innerHTML += '<b>धन्यवाद!<figure style="float: right;"><figcaption style="text-align: center; font-weight: 600;">अध्यक्ष</figcaption><img  width="200px" src="sign-removebg-preview.png" alt=""></figure> </b></p>';
    document.querySelector(".date").textContent = "दिनांक: " + cur_date;
    document.querySelector(".paper1").textContent = cur_sno;
